...
class EmployeeRequestCommentRepository {
    ...
    async Create(employeeRequestComment: EmployeeRequestComment): Promise<EmployeeRequestComment> {
        try {
    ...
    async Update(id: number, dataToUpdate: Partial<EmployeeRequestComment>, userId: number): Promise<EmployeeRequestComment | null> {
        try {
    ...
    async Delete(id: number, userId: number): Promise<EmployeeRequestComment | null> {
        try {
