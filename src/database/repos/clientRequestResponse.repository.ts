...
class ClientRequestResponseRepository {
    ...
    async Create(clientRequestResponse: ClientRequestResponse): Promise<ClientRequestResponse> {
        try {
    ...
    async Update(id: number, dataToUpdate: Partial<ClientRequestResponse>, userId: number): Promise<ClientRequestResponse | null> {
        try {
    ...
    async Delete(id: number, userId: number): Promise<ClientRequestResponse | null> {
        try {
