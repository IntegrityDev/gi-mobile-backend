import { ReportCommentPhoto } from "../database/models";
import { ReportCommentPhotoRepository } from "../database/repos";
import { FormateData } from "../utils";

class ReportCommentPhotoService {
    private repository: ReportCommentPhotoRepository;

    constructor() {
        this.repository = new ReportCommentPhotoRepository();
    }

    async Create(entry: ReportCommentPhoto) {     
        try {
...
export default ReportCommentPhotoService;
