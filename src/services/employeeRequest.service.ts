import { EmployeeRequest } from "../database/models";
import { EmployeeRequestRepository } from "../database/repos";
import { FormateData } from "../utils";

class EmployeeRequestService {
    private repository: EmployeeRequestRepository;

    constructor() {
        this.repository = new EmployeeRequestRepository();
    }

    async Create(entry: EmployeeRequest) {     
        try {
